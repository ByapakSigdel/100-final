...
const FooterBlock: FunctionComponent<FooterBlockType> = ({
  ...
  return (
    <footer
      className={`self-stretch flex flex-row items-start justify-start py-0 pr-0 pl-[31px] box-border max-w-full text-left text-lg text-grey-90 font-barlow ${className}`}
    >
      <div className="w-[1920px] box-border flex flex-col items-center justify-start py-[50px] px-5 relative max-w-[102%] shrink-0 border-t-[1px] border-solid border-grey-15">
        <FooterMainBlock />
        ...
        <img
          className="w-[524.9px] h-[500px] absolute !m-[0] top-[-354px] left-[-85px] object-cover z-[1]"
          alt=""
          src="/hunderd--text--1@2x.png"
        />
        <img
          className="w-[524.9px] h-[500px] absolute !m-[0] top-[-344px] right-[-135.9px] object-cover z-[1]"
          alt=""
          src="/hunderd--text--1@2x.png"
        />
      </div>
